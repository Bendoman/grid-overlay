...
originXinput.addEventListener("change", () => {
    var inputIsNumber = !isNaN(originXinput.value);
    if(inputIsNumber && originXinput.value != '') {
        gridOriginX = parseInt(originXinput.value);
...
originYinput.addEventListener("change", () => {
    var inputIsNumber = !isNaN(originXinput.value);
    if(inputIsNumber && originXinput.value != '') {
        gridOriginY = parseInt(originYinput.value);
...
grid_canvas.addEventListener("pointerdown", (e) => {
